...
var _scryptAsync = async function(passwd, salt, N3, r, p, dkLen, onProgress) {
  return await _nobleAsync(passwd, salt, { N: N3, r, p, dkLen, onProgress });
};
var _scryptSync = function(passwd, salt, N3, r, p, dkLen) {
  return _nobleSync(passwd, salt, { N: N3, r, p, dkLen });
};
var __scryptAsync = _scryptAsync;
var __scryptSync = _scryptSync;
async function scrypt(_passwd, _salt, N3, r, p, dkLen, progress) {
...
function getVersionedHash(version2, hash) {
  ...
  versioned += sha2562(hash).substring(4);
  return "0x" + versioned;
}
...
async function decryptKeystoreJson(json, _password, progress) {
  ...
  assert(params.name === "scrypt", "cannot be reached", "UNKNOWN_ERROR", { params });
  const { salt, N: N3, r, p, dkLen } = params;
  const key = await scrypt(password, salt, N3, r, p, dkLen, progress);
  return getAccount(data, key);
}
...
var HDNodeWallet = class _HDNodeWallet extends BaseWallet {
  ...
  constructor(guard, signingKey, parentFingerprint, chainCode, path, index, depth, mnemonic, provider) {
    ...
    const fingerprint = dataSlice(ripemd160(sha2562(this.publicKey)), 0, 4);
    defineProperties(this, {
      parentFingerprint,
      fingerprint,
      chainCode,
...
var HDNodeVoidWallet = class _HDNodeVoidWallet extends VoidSigner {
  ...
  constructor(guard, address, publicKey, parentFingerprint, chainCode, path, index, depth, provider) {
    ...
    const fingerprint = dataSlice(ripemd160(sha2562(publicKey)), 0, 4);
    defineProperties(this, {
      publicKey,
      fingerprint,
      parentFingerprint,
